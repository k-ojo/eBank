...
const TransferPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTransferStatus("Pending Approval – Charges Required");
      toast.warning("Transfer initiated! Payment of charges required to complete.");
    } catch (error) {
            ...
            <div className="space-y-4">
              ...
              {transferStatus && (
                <Alert className="bg-yellow-50 border-yellow-200">
                  ...
                  <AlertTitle className="text-yellow-800">Transfer Status</AlertTitle>
